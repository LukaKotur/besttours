...
<body>
  ...
  <div class="container" id="template-article">
    ...
    <div class="eta col-lg-6">
      <p id="5h" class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i class="fa fa-car"></i> 4 sata vožnje</p>
    ...
    <div class="template-text col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <h4 class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>Kombi prevoz do Aerodroma Budimpešta</b></h4>
      <p class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Aerodrom u Budimpešti je najpoznatiji po jeftinim avio kartama. Best Tours agencija prati red letenja na aerodromu u Budimpešti, zbog toga smo Vam omogućili redovne ture do Budimpešte. Put do aerodroma Budimpešta traje između 4 i 5 sati i putnici stižu 2 sata pred sam let. Kako bi se čekirali i imali vremena da bez kašnjenja uđu na svoj let. Best Tours agencija takođe čeka putnike na aerodromu bez dodatnih doplata u slučaju kašnjenja leta.  Mesta za prtljag ima dovoljno pa tako nije ograničen broj prtljaga koji nosite sa sobom.  Kombi prevoz je idealan način i takođe najlakši način da stignete na vreme do aerodroma u Budimpešti (BUD)
<br>
<br>
<a href="http://www.bud.hu/english/passengers/flight_information/departures">Red letenja Aerodrom Budimpešta</a>
<br>
<br>
<b>Cena kombi prevoza do aerodroma u jednom smeru iznosi 30 evra, dok u oba pravca iznosi 50 evra.
