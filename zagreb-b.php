...
<body>
  ...
  <div class="container" id="template-article">
    ...
    <div class="template-text col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <h4 class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>BEČ - ZAGREB - BEČ</b></h4>
      <p class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>Beč Zagreb kombi prevoz</b> sa Best Tours turističkom agencijom povoljno, sigurno i brzo do željene destinacije. Prevoz Beč Zagreb
od adrese u Beču na željenu adresu u Zagrebu. Svakodnevni polasci na relaciji Beč Zagreb kao i svakodnevni povratak Zagreb Beč. Naša vozila primaju do 8 putnika i moguće je skupljanje putnika u drugim gradovima na relaciji Beč Zagreb (Grac Zagreb). Tura Beč Zagreb traje između 4 i 5 sati u zavisnosti od zadržavanja na graničnim prelazima. Putnici iz Graca se mogu takođe prijaviti za ovu rutu ako žele da stignu do Zagreba. Kvalitetna vozila i sigurni vozači za Vaš ugodan i siguran put.
<br>
<br>
<br>
