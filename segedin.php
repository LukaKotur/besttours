...
<body>
  ...
  <div class="container" id="template-article">
    ...
    <div class="eta col-lg-6">
      ...
      <h2 class="template-headline col-lg-12">Segedin</h2>
    </div>
    ...
    <div class="template-images col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="template-image "><img src="images/gradovi/segedin.jpg" alt="" class="img-responsive"></div>
      <div id="map-container" class="hidden-xs hidden-sm"></div>
    </div>

    <div class="template-text col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <p class="template-text-info col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>Segedin</b> je glavni grad Republike Hrvatske, i najveći grad u Hrvatskoj po broju stanovnika. Povijesno gledano, Zagreb je izrastao iz dva naselja na susjednim brdima, Gradeca i Kaptola, koji čine jezgru današnjeg Zagreba, njegovo povijesno središte. Zagreb danas predstavlja upravno, gospodarsko, kulturno, prometno i znanstveno središte Hrvatske. Položajem i kulturom spada u gradove srednje Europe. Grad Zagreb je posebna jedinstvena, teritorijalna, upravna i samoupravna jedinica koja ima položaj županije. Zagreb se nalazi u kontinentalnoj središnjoj Hrvatskoj, na južnim obroncima Medvednice te na obalama rijeke Save. Nalazi se na nadmorskoj visini od 122 metara (Zrinjevac). Povoljan zemljopisni smještaj na jugozapadnom kutu Panonske nizine, između alpske, dinarske, jadranske i panonske regije, uzrok je činjenici da se Zagreb nalazi na prometno čvorištu puteva između srednje i jugoistočne Europe te Jadranskog mora.</p>
      <h4 class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>BEOGRAD - SEGEDIN - BEOGRAD</b></h4>
      <p class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>Beograd Segedin kombi prevoz</b> sa Best Tours turističkom agencijom povoljno, sigurno i brzo do željene destinacije. Prevoz Beograd Segedin od adrese u Beogradu na željenu adresu u Segedinu. Svakodnevni polasci na relaciji Beograd Segedin kao i svakodnevni povratak Segedin Beograd. Naša vozila primaju do 8 putnika i moguće je skupljanje putnika u drugim gradovima na relaciji Beograd Segedin. Gradovi koje još radimo na ovoj destinaciji su Novi Sad i Subotica. Tura Beograd Segedin traje između 3 i 4 sata u zavisnosti od zadržavanja na graničnim prelazima. Kvalitetna vozila i sigurni vozači za Vaš ugodan i siguran put.
<br>
<br>
<b>Cena karte u jednom smeru iznosi 25 evra dok u oba izosi 40 evra. Za studente, učenike i penzionere specijalan popust.</b>
</span></p>
    </div>
